...
if($WF_ACTION =="36001" || $WF_ACTION =="36002" || $WF_ACTION =="36003"){ // Forward
	...
	$wfusers = ", wfusers = concat(wfusers,',',(select tbl_workflowline.users from tbl_workflowline right join tbl_workflow on tbl_workflow.id=tbl_workflowline.parentid
where objectid=".$_REQUEST['objectid']." and tbl_workflowline.sequencer=($wf_sequencer+1) and tbl_workflow.companycode=$wf_table.companycode and tbl_workflow.profitcenter=$wf_table.divisioncode and tbl_workflow.module ='".$_SESSION['usermodulecode']."') )";
