...
<h2 class='title'>USER PRIVILEDGES</h2>
</section>
...
<?php
		...
		$id_field = 'tbl_usergroup.id';
		$fieldNames = array('', 'Sl No','User Group','Note');
		$fieldSizes = array('',10,30,50,10);
		$fieldAlign = array('','left','left','left','left');
		$fields = array( 'tbl_usergroup.slno', 'tbl_usergroup.usergroup','tbl_usergroup.remarks');
		$table = "tbl_usergroup";
		$formlistname = "userprivilegessetup.php";
		$formeditlist= "edituserprivilegessetup.php";
        ...
        //$grid->editFields = array("slno,menu_code,rolecode,status");
