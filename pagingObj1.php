                      ...
                      if($topcombo!=""){
                           ...
                           if($topcomboselected!="Select" && $topcomboselected!=""){
                             if($buttons["insert"]=="true"){
                                echo "&nbsp;&nbsp;<button class='btn btn-success' style='padding-left:5px;padding-right:5px;margin-top:-15px;height:30px;' type='button' onclick ='javascript:newrecord(\"".$formeditlist."\");'>Add New <i class='fa fa-plus' aria-hidden='true'></i></button>";
                             }
                             if($buttons["delete"]=="true"){
                                echo "&nbsp;&nbsp;<button class='btn btn-danger' style='padding-left:5px;padding-right:5px;margin-top:-15px;height:30px;' type='button'  onclick ='javascript:deleterecord(\"".$formlistname."\");'>Delete <i class='fa fa-trash' aria-hidden='true'></i></button>";
                             }
                          }
                          echo "</td></table>";
                     }else{
                          ...
                          if($buttons["delete"]=="true"){
                                echo "&nbsp;&nbsp;<button class='btn btn-danger' style='padding-left:5px;padding-right:5px;margin-top:-5px;height:30px;' type='button'  onclick ='javascript:deleterecord(\"".$formlistname."\");'>Delete <i class='fa fa-trash' aria-hidden='true'></i></button>";
                          }
                          echo "</td></tr></table>";
                     }
                    ...
                    echo  "</span><div class='box-tools pull-right '>
                                          ...
                                          <table class='table table-condensed smart-form' style='margin-top:-5px;'>
                                             <tr>
                                                ...
                                                <td>
                                                                        ...
                                                                        <select name='frmPage_rowcount' id='frmPage_rowcount' class='form-control' style='padding-left:5px;padding-right:5px;margin-top:-1px;width:50px;' onchange='javascript:document.frmPage.action=\"$formlistname\";document.frmPage.submit();' >
                                         ...
                                         if ($result)
                                         {
                                                 ...
                                                 while ($row = mysqli_fetch_array($result))
                                                 {
                                                         ...
                                                         if ($buttons['delete']=="true"){
                                                                 ...
                                                                 if($formlistname=="emp_leaverequest.php" && ($row['lmstatus']=="PENDING" || $row['lmstatus']=="APPROVED")){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
                                                                 }elseif($formlistname=="mydocrequest.php" && ($row['status']!="")){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
                                                                 }elseif($formlistname=="grievancerequest.php" && ($row['status']!="")){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
                                                                 }elseif($formlistname=="jobrequest.php" && ($row['status']!="")){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
                                                                 }elseif($formlistname=="lookuplist.php" && ($row['posted']=="YES")){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
                                                                 }
                                                                 /*elseif(($row['posted']=="YES")&&($formlistname=="costcenterlist.php" || $formlistname=="profitcenterlist.php" || $formlistname=="joblist.php" || $formlistname=="trainingprogramme.php" || $formlistname=="trainingcalendar.php" || $formlistname=="techpropertylist.php")){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
                                                                 }*/
                                                                 /*elseif(($row['lm_post']=="YES")&&($formlistname=="emp_appraisalrequest.php")){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
                                                                 }*/else{
                                                                 ...
                                                                 echo "<td style='width:2%;border:1px #D2D2D2 solid;'>";
                                                                 echo "<a href='javascript:void(0);' onclick='javascript:editRecord($keyvalues,\"".$formeditlist."\",\"edit\");return false;'><span class='glyphicon glyphicon-pencil'></span></a>";
                                                                 echo "</td>";
                                                         ...
                                                         while ($i < mysqli_num_fields($result))
                                                         {
                                                               ...
                                                               if($mysql_field_name=="docs" && $rowvalue!=""){
                                                               //if(mysqli_field_name($result,$i)=="docs" && $rowvalue!=""){
                                                                echo "<td style='border:1px #D2D2D2 solid;font-weight:400;text-align:".$fieldAlign[$i].";width:".$fieldSizes[$i]."%;'>";
                                                                echo "<a href='uploads/".$rowvalue."' target=_blank><i class='fa fa-search' data-toggle='tooltip' data-placement='right' title='View' aria-hidden='true'></i></a>";
                                                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href='download.php?folder=uploads&filename=".$rowvalue."'><i class='fa fa-download' data-toggle='tooltip' data-placement='right' title='Download' aria-hidden='true'></i></a>";
                                                                echo "</td>";
                                                               }else{
                                                                echo "<td style='border:1px #D2D2D2 solid;font-weight:400;text-align:".$fieldAlign[$i].";width:".$fieldSizes[$i]."%;'>";
                                                                echo "$rowvalue";
                       ...
                       echo              "</tbody>
                            ...
                            <div class='box-footer' id='box-footer-id' style='border-top:1px #D2D2D2 solid;'>
                                ...
                                /*if($_REQUEST["txtgopage"]!=''){
                                   $gostartrow= ($_REQUEST["txtgopage"]-1)*10;
                                   $gostartpage= 51;
                                   $goendpage= 60;
                                }*/
        ...
        private function navigationLinks($formlistname,$totalrec, $rowcount, $startpage, $currentpage, $endpage, $sortid, $sortdir, $fid, $fvalue,$pagenumber,$gostartrow,$gostartpage,$goendpage,$startrow)
        {
                ...
                if ($currentpage > 1)
                {
                        ...
                        echo "<li><a href='#' onclick='javascript:document.$this->name.$this->_startrow.value=\"$start\";
                                        ...
                                        document.$this->name.$this->_endpage.value=\"$fendpage\";document.frmPage.action=\"$formlistname\";document.$this->name.submit();'><span aria-hidden='true'>&laquo;</span></a></li>";
                }
                echo "</ul>";
                ...
                /*if($_REQUEST["frmPage_rowcount"]==''){
                   ...
                   $pagerecords=$_REQUEST["frmPage_rowcount"];
                }*/
                      ...
                      if($pageno>0){
                        if($startfrom==$pagenumber){
                          echo "<li class='$class'><a href='#' onclick='javascript:document.$this->name.$this->_startrow.value=\"$start\";
                                        ...
                                        document.$this->name.$this->_endpage.value=\"$endpage\";document.frmPage.action=\"$formlistname\";document.$this->name.submit();'>&nbsp;<B><font color='000000' style='text-decoration:underline'>$pagenumber</font></B>&nbsp;</a></li>";

                        }else{
                          echo "<li class='$class'><a href='#' onclick='javascript:document.$this->name.$this->_startrow.value=\"$start\";
                                        document.$this->name.$this->_startpage.value=\"$startpage\";document.$this->name.$this->_currentpage.value=\"$currentpage\";
                                        document.$this->name.$this->_endpage.value=\"$endpage\";document.frmPage.action=\"$formlistname\";document.$this->name.submit();'>&nbsp;$startfrom&nbsp;</a></li>";
                ...
                if (($totalpages * $currentpage) < $pagecount && $totalpages == 10)
                {
                       ...
                       echo "<li><a href='#'  onclick='javascript:document.$this->name.$this->_startrow.value=\"$start\";
                                        ...
                                        document.$this->name.$this->_endpage.value=\"$lendpage\";document.frmPage.action=\"$formlistname\";document.$this->name.submit();'><span aria-hidden='true'>&raquo;</span></a></li>";
                }
