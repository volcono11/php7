...
<h2 class='title'>DEPARTMENT / DIVISION LIST</h2>
</section>
...
<?php
		...
		$id_field = 'tbl_division.id';
		$fieldNames = array('','Division Name','Company');
		$fieldSizes = array('',30,60);
		$fieldAlign = array('','left','left');
		$fields = array( 'divisionname','tbl_companysetup.companyname');
		$table = 'tbl_division left join tbl_companysetup on tbl_companysetup.companycode=tbl_division.companycode';
		$formlistname = "departmentlist.php";
		$formeditlist= "editdepartmentlist.php";
        ...
        $clause = " (divisionname LIKE '%$findBysearch%' or companyname LIKE '%$findBysearch%')";//
        ...
        $grid->editFields = array("id,divisionname");

        $grid->editRecord = $update;

        $grid->TableName = "tbl_division";

        $grid->formName = "departmentlist.php";
