...
*/
		...
		$id_field = 'tbl_country.id';
		$fieldNames = array('','Code','Name');
		$fieldSizes = array('','30','70');
		$fieldAlign = array('','left','left');
		$fields = array('tbl_country.id', 'tbl_country.country');
		$table = 'tbl_country';
		$formlistname = "countrylist.php";
		$formeditlist= "editcountrylist.php";
        ...
        $clause = " (tbl_country.id LIKE '%$findBysearch%'
                     or tbl_country.country LIKE '%$findBysearch%')";
		...
		$grid->TableName = "tbl_country";

		$grid->formName = "countrylist.php";
