...
*/
		...
		$fieldNames = array('','Look Code','Look Type');
		$fieldSizes = array('','30','70');
		$fieldAlign = array('','left','left');
		$fields = array('in_lookup.lookcode', 'in_lookup.looktype');
		$table = 'in_lookup';
		$formlistname = "lookup.php";
		$formeditlist= "editlookup.php";
        ...
        $clause = " (in_lookup.lookcode LIKE '%$findBysearch%'
                     or in_lookup.lookname LIKE '%$findBysearch%' or in_lookup.looktype LIKE '%$findBysearch%') and  lookname='XX'";
