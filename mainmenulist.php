...
<h2 class='title'>MAIN MENU</h2>
         ...
         /* $findBycode = isset($_POST['txtlookcode']) ? $_POST['txtlookcode'] : '';
          ...
          $id_field = 'id';
          $fieldNames = array('', 'Sl No','Menu Name');
           $fieldSizes = array('',10,60);
           $fieldAlign = array('','left','left');
           $fields = array( 'slno', 'name');
          $table = 'inmenu';
          $formlistname = "mainmenulist.php";
          $formeditlist= "editmainmenulist.php";
...
$topcomboselected = '';
    ...
    $_SESSION["txtsearch"]= $findBysearch;
          ...
          $clause = " (name LIKE '%$findBysearch%') and parentid='0'";
         ...
         // echo $clause;
          ...
          $grid->editFields = array("slno,name,roles");

          $grid->editRecord = $update;

          $grid->TabsNames = array("Main Menu Details:1:4");
