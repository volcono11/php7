...
<?php
		...
		$id_field = 'tbl_property.id';
		$fieldNames = array('', 'Property Name','Construction Type','Ownership','No of Blocks','No Of Floors');
		$fieldSizes = array('',20,20,20,10,10);
		$fieldAlign = array('','left','left','left','left','left');
		$fields = array( 'propertyname','A.constructiontype','B.lookname','noofblocks','nooffloors');
		$table = 'tbl_property inner join tbl_constructiontype as A on tbl_property.constructiontype=A.id inner join in_lookup as B on tbl_property.ownership=B.lookcode';
		$formlistname = "propertylist.php";
		$formeditlist= "editpropertylist.php";
        ...
        $clause = " (propertyname LIKE '%$findBysearch%' or A.constructiontype LIKE '%$findBysearch%'or B.lookname LIKE '%$findBysearch%' or noofblocks LIKE '%$findBysearch%' or nooffloors LIKE '%$findBysearch%')";//
        ...
        $grid->editFields = array("propertyname,propertytype");
