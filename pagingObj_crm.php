                ...
                <section class='content' id='section-content-id' style='padding-right:5px;padding-left:5px;margin-top:-10px;' >
                      ...
                      if($topcomboselected!="Select" && $topcomboselected!=""){
                             ...
                             if($buttons["delete"]=="true"){
                                echo "&nbsp;&nbsp;<button class='btn btn-danger' style='padding-left:5px;padding-right:5px;margin-top:-5px;height:30px;' type='button'  onclick ='javascript:deleterecord_pro(\"".$formlistname."\");'>Delete <i class='fa fa-trash' aria-hidden='true'></i></button>";
                             }
                          }
                          echo "</td></table>";
                     }else{
                                         ...
                                         if ($result)
                                         {
                                                 ...
                                                 while ($row = mysqli_fetch_array($result))
                                                 {
                                                         ...
                                                         if ($buttons['delete']=="true"){
                                                                 ...
                                                                 }else if(($formlistname=="assigntask.php") && $row['status']!="Open" ){
                                                                   echo "<span class='glyphicon glyphicon-lock' style='color:#502771'></span>";
