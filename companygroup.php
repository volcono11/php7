...
<h2 class='title'>COMPANY GROUP LIST</h2>
</section>
...
<?php
		...
		$id_field = 'tbl_companygroup.id';
		$fieldNames = array('','Group Name','Company');
		$fieldSizes = array('',30,60);
		$fieldAlign = array('','left','left');
		$fields = array( 'groupname','tbl_companysetup.companyname');
		$table = 'tbl_companygroup left join tbl_companysetup on tbl_companysetup.companycode=tbl_companygroup.companycode';
		$formlistname = "companygroup.php";
		$formeditlist= "editcompanygroup.php";
        ...
        $clause = " (groupname LIKE '%$findBysearch%' or tbl_companygroup.companycode LIKE '%$findBysearch%')";//
        ...
        $grid->editFields = array("id,groupname");

        $grid->editRecord = $update;

        $grid->TableName = "tbl_companygroup";

        $grid->formName = "companygroup.php";
