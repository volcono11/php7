...
<?php
		...
		$id_field = 'tbl_workflow.id';
		$fieldNames = array('','Workflow Name','Company');
		$fieldSizes = array('',30,60);
		$fieldAlign = array('','left','left');
		$fields = array( 'workflowname','tbl_companysetup.companyname');
		$table = 'tbl_workflow left join tbl_companysetup on tbl_companysetup.companycode=tbl_workflow.companycode';
		$formlistname = "workflowsetup.php";
		$formeditlist= "editworkflowsetup.php";
        ...
        $clause = " (workflowname LIKE '%$findBysearch%' or companyname LIKE '%$findBysearch%')";//
        ...
        $grid->editFields = array("id,workflowname");
