...
<?php
		...
		$id_field = 'id';
		$fieldNames = array('','Image Code','Image Name');
		$fieldSizes = array('',30,60);
		$fieldAlign = array('','left','left');
		$fields = array( 'id','imagename');
		$table = 'tbl_statusimages';
		$formlistname = "imagelist.php";
		$formeditlist= "editimagelist.php";
        ...
        $clause = " (imagename LIKE '%$findBysearch%')";//
        ...
        $grid->editFields = array("id,imagename");

        $grid->editRecord = $update;

        $grid->TableName = "tbl_statusimages";

        $grid->formName = "imagelist.php";
