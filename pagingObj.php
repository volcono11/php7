                ...
                <section class='content' id='section-content-id' style='padding-right:5px;padding-left:5px;margin-top:-10px;' >
                      ...
                      if($topcomboselected!="Select" && $topcomboselected!=""){
                             ...
                             if($buttons["delete"]=="true"){
                                echo "&nbsp;&nbsp;<button class='btn btn-danger' style='padding-left:5px;padding-right:5px;margin-top:-5px;height:30px;' type='button'  onclick ='javascript:deleterecord_pro(\"".$formlistname."?objectid=".$_SESSION['objectid']."\");'>Delete <i class='fa fa-trash' aria-hidden='true'></i></button>";/*echo "&nbsp;&nbsp;<button class='btn btn-danger' style='padding-left:5px;padding-right:5px;margin-top:-5px;height:30px;' type='button'  onclick ='javascript:deleterecord_pro(\"".$formlistname."?pr=".$_SESSION['pr']."\");'>Delete <i class='fa fa-trash' aria-hidden='true'></i></button>";*/
                             }
                          }
                          echo "</td></table>";
                     }else{
                          ...
                          if($buttons["insert"]=="true"){
                               ...
                               echo "&nbsp;&nbsp;<button class='btn btn-success' style='padding-left:5px;padding-right:5px;margin-top:-3px;height:30px;' type='button' onclick ='javascript:newrecord(\"".$formeditlist."\");'>Add New <i class='fa fa-plus' aria-hidden='true'></i></button>";
                          }
                          if($buttons["delete"]=="true"){
                                echo "&nbsp;&nbsp;<button class='btn btn-danger' style='padding-left:5px;padding-right:5px;margin-top:-5px;height:30px;' type='button'  onclick ='javascript:deleterecord_pro(\"".$formlistname."?objectid=".$_SESSION['objectid']."\");'>Delete <i class='fa fa-trash' aria-hidden='true'></i></button>";
                             }
                    ...
                    echo  "</span><div class='box-tools pull-right '>
                                      ...
                                      <thead >
                                         <tr >";
                                           ...
                                           if ($buttons['delete']=="false")
                                           {
                                                  ...
                                                  echo "<th class='bg-light-blue' style='width:3%;text-align:left;border-bottom:1px #2F3C43 solid;border-top:1px #fff solid;color:#FFFFFF'>";
                                                  echo "&nbsp;";
                                                  echo "</th>";
                                           $k = 0;
                           ...
                           echo          "</tr>
                          	 ...
                          	 $delete_li = " <li><a href='javascript:deleterecord_single(\"".$formlistname."?objectid=".$_SESSION['objectid']."\",\"".$row['id']."\");'><i class='fa fa-trash'></i>Delete</a></li>";
                                                                 ...
                                                                 echo '<div class="dropdown">
  																       <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="height:18px;width:18px;padding:3px;"><span class="caret"></span></button>
  																	   <ul class="dropdown-menu dropdown-light-blue">
  																	   '.$delete_li.'
  																	   '.$delete_li.'
  																	   '.$delete_li.'
                                                         ...
                                                         while ($i < mysqli_num_fields($result))
                                                         {
                                                           ...
                                                           /* if($mysql_field_name=="stcheck" && $rowvalue=="Open" && ($formlistname=="calloutrequest.php" || $formlistname=="emgcalloutrequest.php" || $formlistname=="calloutrequest.php" || $formlistname=="otleadheadlist.php" || $formlistname=="newleadheadlist.php" || $formlistname=="quoteheadlist.php" || $formlistname=="otquoteheadlist.php" || $formlistname=="salesorderheadlist.php" || $formlistname=="otsalesorderheadlist.php" || $formlistname=="emgquoteheadlist.php" || $formlistname=="emgsalesorderheadlist.php")){
                                                            ...
                                                            else*/ if($mysql_field_name=="wfstatus"  && ($formlistname=="calloutrequest.php" || $formlistname=="emgcalloutrequest.php" || $formlistname=="calloutrequest.php" || $formlistname=="otleadheadlist.php" || $formlistname=="newleadheadlist.php" || $formlistname=="quoteheadlist.php" || $formlistname=="otquoteheadlist.php" || $formlistname=="salesorderheadlist.php" || $formlistname=="otsalesorderheadlist.php" || $formlistname=="emgquoteheadlist.php" || $formlistname=="emgsalesorderheadlist.php")){
                                                                   echo "<td style='border:1px #D2D2D2 solid;font-weight:400;text-align:".$fieldAlign[$i].";width:".$fieldSizes[$i]."%;'>";
                                                                   echo "<img src='statusimages/$imagefile' title='$Title'  data-toggle='tooltip' data-placement='left' width='16' height='16'>";
                                                                   echo "</td>";
                                                            }
...
function getRowStatus($con,$statusname){
      $SQL = "select statusname,tbl_status.statusimage as imagename from tbl_status where id = '$statusname'";
      $SQLRes =  mysqli_query($con,$SQL) or die(mysqli_error()."<br>".$SQL);
      $imgname = "";
      if(mysqli_num_rows($SQLRes)>=1){
