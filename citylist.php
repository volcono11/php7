...
*/
		...
		$id_field = 'tbl_city.id';
		$fieldNames = array('','Emirate','City');
		$fieldSizes = array('','50','50');
		$fieldAlign = array('','left','left');
		$fields = array( 'tbl_states.emirate','tbl_city.city');
		$table = 'tbl_city left join tbl_states on tbl_states.id=tbl_city.emirateid';
		$formlistname = "citylist.php";
		$formeditlist= "editcitylist.php";
        ...
        $clause = " (tbl_city.city LIKE '%$findBysearch%'
		...
		$grid->TableName = "tbl_city";

		$grid->formName = "citylist.php";
