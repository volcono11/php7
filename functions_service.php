...
function GetUpload($RequestFile,$seqID,$PostedUser){
 ...
 function GetWord($word){
        ...
        if ($temp=="" and $word != ''){
            ...
            $result = @mysql_query($strSQL) ; //die(mysql_error()."<br>".$strSQL);                            //  Forcing the execution to avoid duplicate error display
 ...
 FUNCTION Send_External_Mail($From_Name,$From,$To_Arr,$Subject,$Body,$Attachment_file,$CC){
           ...
           // if(count($_SESSION['SMPT']) < 1) return "FAILED";
            ...
            $mail = new PHPMailer();
            $mail->IsSMTP();
            $mail->Host = "ssl://box1383.bluehost.com___";
            $mail->Port = 465;
            $mail->SMTPAuth = true;
            $mail->Username = "test@cpsdubai.com___";
            $mail->Password = "Test@123456___";
            $mail->From = $From;
            $mail->FromName = $From_Name;
            $mail->SetLanguage("en", 'language/');
...
Function Getmailbody($projectcode,$fromemail,$fromname,$subject,$bodymessage){
      $html="<TABLE WIDTH='500' ALIGN='center' HEIGHT='500'  cellpadding=0 cellspacing=0 style='border:2px solid #3C8DBC;'>
                   <TR HEIGHT='40' style='background-color:#3C8DBC;color:#FFFFFF;text-align:center;font-size:2.5em;font-weight:bold;'>
                    <TD COLSPAN=2 style='padding-top:10px; padding-bottom:10px; font-family:Arial, Helvetica, sans-serif; font-stretch:ultra-condensed;'>Radius-Test</TD>
                   </TR>
                                   <TR>
                    <TD colspan=2 style='padding-top:20px;'>&nbsp;</TD>
                      ...
                      <tr><td colspan=2 align='left' style='FONT-SIZE: 12px; BORDER-BOTTOM: #FFFFFF 1px solid; HEIGHT: 25px;FONT-COLOR: #000000; VALIGN: Bottom;padding-bottom: 5px;
                                        padding-left:2px; font-weight:bold; FONT-FAMILY: Tahoma;'>&nbsp;RADIUS ERP- <a href='http://kemos.cpsdubai.com'><u> Login Here </u></a></td></tr>
                     </TABLE>";
...
Function Getnotificationmail($projectcode,$fromemail,$fromname,$subject,$bodymessage){
      $html="<TABLE WIDTH='500' ALIGN='center' HEIGHT='500'  cellpadding=0 cellspacing=0 style='border:2px solid #3C8DBC;'>
                   <TR HEIGHT='40' style='background-color:#3C8DBC;color:#FFFFFF;text-align:center;font-size:2.5em;font-weight:bold;'>
                    <TD COLSPAN=2 style='padding-top:10px; padding-bottom:10px; font-family:Arial, Helvetica, sans-serif; font-stretch:ultra-condensed;'>Radius Test Mail</TD>
                   </TR>
                                   <TR>
                    <TD colspan=2 style='padding-top:20px;'>&nbsp;</TD>
                   </TR>";
                       ...
                       <TR  HEIGHT='80%' valign='bottom'>
                        <TD colspan=2 align='left' style='FONT-SIZE: 12px; BORDER-BOTTOM: #FFFFFF 1px solid; HEIGHT: 25px;FONT-COLOR: #000000; VALIGN: Bottom;padding-bottom: 5px;
                                        padding-left:2px; font-weight:bold; FONT-FAMILY: Tahoma;'>&nbsp;Regards,<br>
                                                &nbsp;RADIUS ERP- <a href='http://kemos.cpsdubai.com'><u> Login Here </u></a>
                                                <br><br>&nbsp;(System generated message)<br>&nbsp;
                                                </TD>
                      </TR>
...
function Getlookname($lookcode,$type){
      ...
      $LookRes = mysql_query($LookSQL) or die(mysql_error().'<br>8989'.$LookSQL);
      $LookArr = mysql_fetch_array($LookRes);
