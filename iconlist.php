...
<?php
		...
		$id_field = 'id';
		$fieldNames = array('','Icon Code','Icon Name');
		$fieldSizes = array('',30,60);
		$fieldAlign = array('','left','left');
		$fields = array( 'id','iconname');
		$table = 'tbl_icons';
		$formlistname = "iconlist.php";
		$formeditlist= "editiconlist.php";
        ...
        $clause = " (iconname LIKE '%$findBysearch%')";//
        ...
        $grid->editFields = array("id,iconname");

        $grid->editRecord = $update;

        $grid->TableName = "tbl_icons";

        $grid->formName = "iconlist.php";
