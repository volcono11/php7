...
<?php
		...
		$id_field = 'id';
		$fieldNames = array('', 'Sl No','Menu Code','Menu Name');
		$fieldSizes = array('',10,30,60);
		$fieldAlign = array('','left','left','left');
		$fields = array( 'slno', 'menu_code','menu_name');
		$table = 'tbl_menu';
		$formlistname = "menulist.php";
		$formeditlist= "editmenulist.php";
        ...
        $clause = " (menu_name LIKE '%$findBysearch%')  and parentid='0'";//
        ...
        $grid->editFields = array("slno,menu_code,menu_name");
