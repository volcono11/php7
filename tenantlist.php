...
<?php
		...
		$id_field = 'tbl_tenant.id';
		$fieldNames = array('','Tenant Type','Tenant Name','Contact No','Contact Person');
		$fieldSizes = array('',20,20,20,20);
		$fieldAlign = array('','left','left','left','left');
		$fields = array('A.lookname','tenantname','contactno','contactperson');
		$table = 'tbl_tenant left join in_lookup as A on tbl_tenant.tenanttype=A.lookcode';
		$formlistname = "tenantlist.php";
		$formeditlist= "edittenantlist.php";
        ...
        $clause = " (A.lookname LIKE '%$findBysearch%' or tenantname LIKE '%$findBysearch%'  or contactperson LIKE '%$findBysearch%' or contactno LIKE '%$findBysearch%')";//
        ...
        $grid->editFields = array("id");

        $grid->editRecord = $update;

        $grid->TableName = "tbl_tenant";

        $grid->formName = "tenantlist.php";
