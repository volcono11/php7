...
<?php
	...
	<select name='cmb_lookuplist1' id='cmb_lookuplist1' class='form-control select2' style='padding-left:5px;padding-right:5px;margin-top:-5px;height:30px;weight:210px;font-weight:normal;' onchange=javascript:refreshPaging2('amcleadheadlist.php?objectid=".$_SESSION['objectid']."');>";
	...
	$topcombo1 .= "<label class='select'>
	            ...
	            <select name='cmb_lookuplist' id='cmb_lookuplist'
	                    ...
	                    onchange=javascript:refreshPaging('amcleadheadlist.php');>";
...
(select max(id) from in_crmhead as ch1 where ch1.parentdocno=in_crmhead.docno)) as quotevalue";
	...
	$formlistname = "amcleadheadlist.php";
	$formeditlist= "editamcleadheadlist.php";
	...
	$grid->formName = "amcleadheadlist.php";
